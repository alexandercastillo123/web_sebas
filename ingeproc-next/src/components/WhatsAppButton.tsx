...
export default function WhatsAppButton() {
  ...
  return (
    <Link href={whatsappUrl} target="_blank" rel="noopener noreferrer"
      className="fixed bottom-6 right-6 z-50 p-2 rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center group"
      aria-label="Contactar por WhatsApp"
    >
      <svg viewBox="0 0 448 512" className="w-14 h-14 fill-current group-hover:rotate-12 transition-transform duration-300">
